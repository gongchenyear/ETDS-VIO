...
int main(int argc, char** argv)
{
	...
	pubGPS = n.advertise<sensor_msgs::NavSatFix>("/gps_drt_dyn", 1000);

	if(argc != 3)
	{
		printf("please intput: rosrun vins_drt_dyn kitti_gps_test_drt_dyn [config file] [data folder] \n"
			   "for example: rosrun vins_drt_dyn kitti_gps_test_drt_dyn "
